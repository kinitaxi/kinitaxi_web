...
define('USERNAME', sizeof($argv) >= 3 ? $argv[1] : 'EliteHive');
define('PASSWORD', sizeof($argv) >= 3 ? $argv[2] : 'lovelaicon');

// Fill your data:
define('FROM', 'Intract'); // Sender name/address
define('TO', '2348135718084'); // Receiver address
define('NOTIFY_URL', '');
